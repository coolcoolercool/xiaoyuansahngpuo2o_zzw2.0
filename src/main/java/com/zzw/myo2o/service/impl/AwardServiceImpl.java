...
import com.zzw.myo2o.util.ImageUtil2;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import org.springframework.web.multipart.commons.CommonsMultipartFile;

import com.zzw.myo2o.dao.AwardDao;
import com.zzw.myo2o.dto.AwardExecution;
import com.zzw.myo2o.entity.Award;
import com.zzw.myo2o.enums.AwardStateEnum;
import com.zzw.myo2o.service.AwardService;
...
public class AwardServiceImpl implements AwardService {
	...
	private void addThumbnail(Award award, CommonsMultipartFile thumbnail) {
		...
		String thumbnailAddr = ImageUtil2.generateThumbnail(thumbnail, dest);
